...
export const players = [{ id: 'NvysJ1bND6X1RONVG3Yu', name: 'MJ' }, { id: '0Ujzu57VXWwJTB5erTUp', name: 'Baurice Maltheiser-Targu' }, { id: 'GpBYQ4vqkiEImQrbkkHv', name: 'José Altuve' }, { id: 'yhSG30Rf9lB0Me9sLoRS', name: 'Francis Dubourg' }]
